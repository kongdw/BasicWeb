...
package k0n9.common.repository;

import k0n9.common.entity.search.Searchable;
import k0n9.common.repository.callback.SearchCallback;
...
public class RepositoryHelper {
    ...
    public static EntityManager getEntityManager() {
        Assert.notNull(entityManager, "entityManager must null, please see " +
                "[k0n9.common.repository.RepositoryHelper#setEntityManagerFactory]");
    ...
    /**
     * <p>ql条件查询<br/>
     * searchCallback默认实现请参考 {@see k0n9.common.repository.callback.DefaultSearchCallback}<br/>
     * <p>
     * 测试用例请参考：{@see k0n9.common.repository.UserRepositoryImplForCustomSearchIT}
     * 和{@see k0n9.common.repository.UserRepositoryImplForDefaultSearchIT}
     *
     * @param ql
     ...
     * 具体使用请参考测试用例：{@see k0n9.common.repository.UserRepository2ImplIT#testFindAll()}
     *
     * @param ql
     ...
     * 具体使用请参考测试用例：{@see k0n9.common.repository.UserRepository2ImplIT#testFindOne()}
     *
     * @param ql
     * @param params
     * @param <M>
     ...
     * 具体使用请参考测试用例：k0n9.common.repository.UserRepository2ImplIT#testCountAll()
     *
     * @param ql
     * @param params
     * @return
     ...
     * 具体使用请参考测试用例：{@see k0n9.common.repository.UserRepository2ImplIT#testBatchUpdate()}
     *
     * @param ql
     * @param params
     * @return
