...
package k0n9.extra.aop;

import k0n9.common.cache.BaseCacheAspect;
import k0n9.sys.auth.entity.Auth;
import k0n9.sys.auth.service.AuthService;
import k0n9.sys.group.entity.Group;
import k0n9.sys.group.entity.GroupRelation;
import k0n9.sys.group.service.GroupRelationService;
import k0n9.sys.group.service.GroupService;
import k0n9.sys.organization.entity.Job;
import k0n9.sys.organization.entity.Organization;
import k0n9.sys.organization.service.JobService;
 ...
 * <p/>
 * 1、当调用如下方法时，加缓存
 * {@link k0n9.sys.auth.service.UserAuthService#findRoles}
 * {@link k0n9.sys.auth.service.UserAuthService#findStringRoles}
 * {@link k0n9.sys.auth.service.UserAuthService#findStringPermissions}
 * <p/>
 * 2、授权（Auth）
 * 当增删改授权时，
 * 如果是用户相关的，只删用户的即可，
...
public class UserAuthCacheAspect extends BaseCacheAspect {
     ...
     * 其他的全部清理
     */
    @Pointcut(value = "target(k0n9.sys.auth.service.AuthService)")
     ...
     * 当删除资源时，清缓存
     */
    @Pointcut(value = "target(k0n9.sys.resource.service.ResourceService)")
     ...
     * 当删除权限时，清缓存
     */
    @Pointcut(value = "target(k0n9.sys.permission.service.PermissionService)")
     ...
     * 当删除/修改show字段时，清缓存
     */
    @Pointcut(value = "target(k0n9.sys.organization.service.OrganizationService)")
     ...
     * 当删除/修改show字段时，清缓存
     */
    @Pointcut(value = "target(k0n9.sys.organization.service.JobService)")
     ...
     * 当删除组时，清缓存
     */
    @Pointcut(value = "target(k0n9.sys.group.service.GroupService)")
     ...
     * 其他情况，清所有
     */
    @Pointcut(value = "target(k0n9.sys.group.service.GroupRelationService)")
     ...
     * 修改时，如果组织机构/工作职务变了，仅需清自己的缓存
     */
    @Pointcut(value = "target(k0n9.sys.user.service.UserService)")
    ...
    @Pointcut(value = "target(k0n9.sys.auth.service.UserAuthService)")
