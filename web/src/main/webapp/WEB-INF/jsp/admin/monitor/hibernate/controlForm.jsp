...
<div data-table="table" class="panel">
    ...
    <div class="form-inline">
        ...
        <form class="span7">
            ...
            &nbsp;&nbsp;
            <kform:label path="entityIds">实体编号：</kform:label>
            <kform:input path="entityIds" cssClass="input-medium" placeholder="多个之间，逗号分隔"/>
        </form>
        ...
        <form class="span7">
            ...
            &nbsp;&nbsp;
            <kform:label path="collectionEntityIds">集合所属实体编号：</kform:label>
            <kform:input path="collectionEntityIds" cssClass="input-medium" placeholder="多个之间，逗号分隔"/>
        </form>
        <div style="line-height: 70px;">
