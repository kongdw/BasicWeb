...
<div class="panel">
    ...
    <ul class="nav nav-tabs">
            <c:if test="${op eq '发送草稿'}">
                <li class="active">
                    <a href="${ctx}/admin/personal/message/draft/${m.id}/send?BackURL=<k:BackURL/>">
            ...
            <c:if test="${op eq '发送新消息'}">
                <li class="active">
                    <a href="${ctx}/admin/personal/message/send?BackURL=<k:BackURL/>">
                        <i class="icon-file-alt"></i>
                        ${op}
                    </a>
                </li>
            ...
            <c:if test="${op eq '回复消息'}">
                <li class="active">
                    <a href="${ctx}/admin/personal/message/${parent.id}/reply?BackURL=<k:BackURL/>">
                        <i class="icon-file-alt"></i>
                        ${op}
                    </a>
                </li>
            ...
            <c:if test="${op eq '转发消息'}">
                <li class="active">
                    <a href="${ctx}/admin/personal/message/${parent.id}/forward?BackURL=<k:BackURL/>">
                        <i class="icon-file-alt"></i>
                            ${op}
                    </a>
                </li>
