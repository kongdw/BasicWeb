...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $.zTree.initMovableTree({
            ...
            permission: <k:treePermission resourceIdentity="sys:resource"/>,
            autocomplete : {
                enable : true
            },
            setting : {
                callback : {
                    onClick: function(event, treeId, treeNode, clickFlag) {
                        parent.frames['listFrame'].location.href='${ctx}/admin/sys/organization/organization/' + treeNode.id + "/update?async=" + async;
                    }
                }
            }
        });
