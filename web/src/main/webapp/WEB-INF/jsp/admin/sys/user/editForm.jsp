...
<div class="panel">
    <ul class="nav nav-tabs">
        ...
        <li ${op eq '新增' ? 'class="active"' : ''}>
            <a href="${ctx}/admin/sys/user/create?BackURL=<k:BackURL/>">
        ...
        <li ${op eq '查看' ? 'class="active"' : ''}>
            <a href="${ctx}/admin/sys/user/${m.id}?BackURL=<k:BackURL/>">
        ...
        <li ${op eq '修改' ? 'class="active"' : ''}>
            <a href="${ctx}/admin/sys/user/${m.id}/update?BackURL=<k:BackURL/>">
                <i class="icon-edit"></i>
                修改
            </a>
        </li>
        ...
        <li ${op eq '删除' ? 'class="active"' : ''}>
            <a href="${ctx}/admin/sys/user/${m.id}/delete?BackURL=<k:BackURL/>">
