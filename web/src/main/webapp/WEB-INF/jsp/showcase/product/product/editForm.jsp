    ...
    <ul class="nav nav-tabs">
        ...
        <c:if test="${op eq '新增'}">
            <li ${op eq '新增' ? 'class="active"' : ''}>
                <a href="${ctx}/showcase/product/product/create?BackURL=<k:BackURL/>">
        ...
        <c:if test="${not empty m.id}">
            <li ${op eq '查看' ? 'class="active"' : ''}>
                <a href="${ctx}/showcase/product/product/${m.id}?BackURL=<k:BackURL/>">
            ...
            <li ${op eq '修改' ? 'class="active"' : ''}>
                <a href="${ctx}/showcase/product/product/${m.id}/update?BackURL=<k:BackURL/>">
                    <i class="icon-edit"></i>
                    修改
                </a>
            </li>
            ...
            <li ${op eq '删除' ? 'class="active"' : ''}>
                <a href="${ctx}/showcase/product/product/${m.id}/delete?BackURL=<k:BackURL/>">
