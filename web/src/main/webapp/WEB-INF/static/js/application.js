    ...
    initMenu: function () {
        ...
        menus.find("a").each(function () {
            ...
            var active = function (a, forceRefresh) {
                menus.find("a").closest("li").removeClass("active open");
                menus.children("li:last").addClass("last");
                menus.children("li:first").addClass("start");
                ...
                $parentLi.children('a').find('span[class="arrow"]').addClass("open");
...
$.tabs = {
    ...
    initTab: function () {
        function activeMenu(tabPanelId) {
            $("#menu").find("ul,li,span").removeClass("active open");
            $("#menu").find("span.selected").remove();
            $("#menu ul").hide();

            var currentMenu = $("#menu-" + tabPanelId.replace("tabs-", ""));

            currentMenu.addClass("active open");
            currentMenu.closest("ul").show();
            currentMenu.closest("ul").parent().parent().show();

            var oldMenu = $('#menu .open');
